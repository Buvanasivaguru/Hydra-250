...
#define KILL_PIN           -1
  ...
  #define HEATER_BED_PIN   8    // RAMPS 1.0
...
// for the fan and Teensyduino uses a different pin mapping.
  ...
  #define TEMP_0_PIN          1//1  // Extruder / Analog pin numbering
  #define TEMP_BED_PIN        0//0  // Bed / Analog pin numbering
  #ifdef FILAMENT_SENSOR
...
#ifndef SDSUPPORT
// these pins are defined in the SD library if building with SD support
  #define SCK_PIN          9// 21 //9
  #define MISO_PIN        11 // 22 //11
  #define MOSI_PIN         10 //23 //10
#endif
