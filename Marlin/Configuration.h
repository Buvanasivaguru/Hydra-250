...
#define STRING_VERSION_CONFIG_H __DATE__ "27/6/16 " __TIME__ // build date and time/
#define STRING_CONFIG_H_AUTHOR "(Buvan_Redd, Hydra_250)" // Who made the changes.*******************************************************
...
//#define BED_WATTS (12.0*12.0/1)      // P=I^2/R
...
//Fab-X
   /* #define  DEFAULT_Kp 27.8
    #define  DEFAULT_Ki 1.46
    #define  DEFAULT_Kd 129.89
*/
// MakerGear
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 92.19
    #define  DEFAULT_bedKi 8.79
    #define  DEFAULT_bedKd 241.68
...
//  #define AUTO_BED_LEVELING_GRID
  ...
  // Note: this feature occupies 10'206 byte
    ...
    #define RIGHT_PROBE_BED_POSITION 92
...
//#define BED_CENTER_AT_30_30  // If defined, the center of the bed is at (X=0, Y=0)
...
#define HOMING_FEEDRATE {35*60, 35*60, 4*60, 0}  // set the homing speeds (mm/min){50*60, 50*60, 4*60, 0}
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,800,100}  // default steps per unit for Ultimaker 784
#define DEFAULT_MAX_FEEDRATE          {500, 500, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {9000,9000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
